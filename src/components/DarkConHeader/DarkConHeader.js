        ...
        return (
			<div className="darkconheader">
				...
				<div className="mypage-menu-wrap">
					<div
						className={"mypage-myorder" + (this.props.current === "order" ? " current-mypagesection" : "")}>
						<div className="mypage-myorder-count"></div>
						<Link to="/mypage/myorder">주문내역</Link>
					</div>
					<div
						className={"mypage-myauthentication" + (this.props.current === "auth" ? " current-mypagesection" : "")}>
						<div className="mypage-myauthentication-count"></div>
						<Link to="/mypage/myauth">인증현황</Link>
					</div>
					<div
						className={"mypage-mylikes" + (this.props.current === "likes" ? " current-mypagesection" : "")}>
